...
export const queryKeys = {
  organizations: {
    ...
    detail: (id: string | null | undefined) => [...queryKeys.organizations.all, id] as const,
  },
  memberships: {
    all: ['memberships'] as const,
    byOrg: (organizationId?: string | null) => [...queryKeys.memberships.all, organizationId] as const,
  },
  products: {
    all: ['products'] as const,
    list: (organizationId?: string | null) => [...queryKeys.products.all, organizationId] as const,
  },
