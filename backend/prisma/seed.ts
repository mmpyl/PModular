...
async function main() {
  ...
  // Crear tipos de negocio con sus configuraciones por defecto
  ...
  const ferreteria = await prisma.businessType.upsert({
    ...
    create: {
      ...
      productSchema: {
        ...
        equivalencia: { type: 'string', default: null }, // Ej: "1 galón = 3.785 litros"
  ...
  // Crear una organización de ejemplo para cada tipo
  ...
  // Precargar categorías típicas para cada organización
  ...
  // Precargar unidades de medida típicas
